...
public class PillStatsProcessorFactory implements IRecordProcessorFactory {
    ...
    public PillStatsProcessorFactory(final JedisPool jedisPool, final AmazonDynamoDB dynamoDBClient, final String streamName, final String checkpointTableName) {
    ...
    public IRecordProcessor createProcessor() {
        ...
        return new PillStatsProcessor(activeDevicesTracker, checkpointTracker);
    }
}
